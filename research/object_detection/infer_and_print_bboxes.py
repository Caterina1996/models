...
PATH_TO_TEST_IMAGES= "/home/plome/inference_mines/img/"
PATH_TO_OUTPUT_DIR= "/home/plome/inference_mines/out" 

#EXPORTED MODEL PATH
common2 = "/home/plome/models/research/object_detection/exported_models/mines/mines_frames_bckgrnd/"
path2config = common2 + 'pipeline.config'
path2model =  common2 + 'checkpoint/'
PATH_TO_LABELS= common2 + "/label_map.pbtxt"
...
# plot_bbox(path_to_csv, box_th=0.25,is_gt=True)
    plot_bbox_from_csv(path_to_csv, box_th=0.1)
