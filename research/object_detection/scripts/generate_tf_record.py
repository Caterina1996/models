...
parser.add_argument("-i",
                    ...
                    help="Path to the folder where the input image files are stored"
                         ...
                         "label_map.pbtx should also be found here",type=str, default=None)
...
parser.add_argument("-l",
                    "--labels_path",
                    help="Path to label_map.pbtx folder. Default input path"
                    ,type=str)
...
if args.labels_path is None:
    args.labels_path=args.input_dir

#TO DO: solve this issues to automate label_map reading:
label_map = label_map_util.load_labelmap(args.labels_path+"/label_map.pbtx")
    ...
    for xml_file in glob.glob(path + '/*.xml'):
        ...
        for member in root.findall('object'):
            ...
            if member[0].text not in label_map_dict.keys():
                ...
                print("THIS LABEL IS BEING DISCARDED!!!")
            else: 
